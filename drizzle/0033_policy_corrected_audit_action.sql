...
ALTER TYPE "audit_action" RENAME TO "audit_action_before_policy_corrected";--> statement-breakpoint
...
DROP TYPE "audit_action_before_policy_corrected";--> statement-breakpoint
