...
BEGIN
	IF EXISTS (
		...
		RAISE EXCEPTION 'producer commission receipt audit actions are in use; preserve audit history and forward-fix'
			USING ERRCODE = '55000',
				CONSTRAINT = 'producer_commission_receipt_audit_actions_in_use';
	END IF;
END;
...
ALTER TYPE "audit_action" RENAME TO "audit_action_with_producer_commission_receipt";--> statement-breakpoint
...
DROP TYPE "audit_action_with_producer_commission_receipt";--> statement-breakpoint
