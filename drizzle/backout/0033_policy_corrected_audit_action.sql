...
BEGIN
	IF EXISTS (
		...
		RAISE EXCEPTION 'policy_corrected is in use; preserve audit history and forward-fix'
			USING ERRCODE = '55000',
				CONSTRAINT = 'policy_corrected_audit_action_in_use';
	END IF;
END;
...
ALTER TYPE "audit_action" RENAME TO "audit_action_with_policy_corrected";--> statement-breakpoint
...
DROP TYPE "audit_action_with_policy_corrected";--> statement-breakpoint
