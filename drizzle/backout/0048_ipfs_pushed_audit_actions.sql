...
BEGIN
	IF EXISTS (
		...
		RAISE EXCEPTION 'IPFS pushed-state audit actions are in use; preserve audit history and forward-fix'
			USING ERRCODE = '55000',
				CONSTRAINT = 'policy_ipfs_pushed_audit_actions_in_use';
	END IF;
END;
...
BEGIN
	...
	SET "schema_fingerprint" = '6a06ce086a9beb6b68f788f18afc03712019d56f56003401a9c796fec751991a',
		"migration_count" = 48;

	UPDATE "business_state_control"
	SET "expected_schema_fingerprint" = '6a06ce086a9beb6b68f788f18afc03712019d56f56003401a9c796fec751991a',
...
END;
$$;--> statement-breakpoint
ALTER TABLE "policies" DROP CONSTRAINT "policies_ipfs_state_check";--> statement-breakpoint
ALTER TABLE "policies" ADD CONSTRAINT "policies_ipfs_state_check" CHECK ((
...
ALTER TYPE "audit_action" RENAME TO "audit_action_with_policy_ipfs_pushed";--> statement-breakpoint
...
DROP TYPE "audit_action_with_policy_ipfs_pushed";--> statement-breakpoint
