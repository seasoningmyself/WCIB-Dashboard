...
import { KpisGoals, KpisGoalsView, type KpiScreenState } from "./KpisGoals.js";
...
test("KPI view exposes bounded loading, error, denied, and responsive layouts", () => {
  for (const [status, expected] of [
    ["loading", "Loading KPIs"],
    ["error", "Try again"],
    ["denied", "not available for your account"],
  ] as const) {
    const markup = renderView({ state: { status } });
